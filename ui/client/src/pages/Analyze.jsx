...
export default function Analyze() {
  ...
  return (
    <div className="page-container page-container-2x2">
      ...
      {/* Performance Metrics */}
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", maxWidth: "100%", padding: "1rem", boxSizing: "border-box" }}>
        <div className="grid-item" style={{ flex: "1 1 45%", margin: "1rem" }}>
